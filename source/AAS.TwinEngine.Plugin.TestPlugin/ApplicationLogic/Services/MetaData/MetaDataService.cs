...
{
    public async Task<ShellDescriptorsData> GetShellDescriptorsAsync(
        int? limit,
        string? cursor,
        ...
        => await metaDataProvider.GetShellDescriptorsAsync(limit, cursor, filter, idShort, assetKind, assetType, cancellationToken);
