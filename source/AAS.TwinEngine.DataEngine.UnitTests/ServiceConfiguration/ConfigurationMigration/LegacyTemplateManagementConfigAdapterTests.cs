...
public class LegacyTemplateManagementConfigAdapterTests
{
    ...
    public void Configure_WithV1Config_MapsAasTemplateRegistry()
    {
        ...
        Assert.Equal(AasEnvironmentConfig.AasRegistryHttpClientName, options.AasTemplateRegistry.Name);
    ...
    public void Configure_WithV1Config_MapsSubmodelTemplateRegistry()
    {
        ...
        Assert.Equal(AasEnvironmentConfig.SubmodelRegistryHttpClientName, options.SubmodelTemplateRegistry.Name);
